...
[CONTRIBUTING.md](https://github.com/mne-tools/mne-connectivity/blob/main/CONTRIBUTING.md)
and the [detailed contribution guidelines of MNE-Python](https://mne.tools/dev/development/contributing.html)
before submitting.
...
[MNE-Python's CONTRIBUTING.md](https://github.com/mne-tools/mne-python/blob/main/CONTRIBUTING.md).
