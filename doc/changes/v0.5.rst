...
- Fix handling of the ``verbose`` argument by :func:`mne_connectivity.spectral_connectivity_epochs`, :func:`mne_connectivity.spectral_connectivity_time`, :func:`mne_connectivity.vector_auto_regression` by `Sam Steingold`_ (:pr:`111`)
...
- The ``sfreq`` parameter is now required for numpy array inputs to :func:`mne_connectivity.spectral_connectivity_epochs`, by `Adam Li`_ (:pr:`119`)
