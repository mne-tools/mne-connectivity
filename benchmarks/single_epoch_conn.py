...
def main():
    ...
    epochs = make_fixed_length_epochs(raw=raw, duration=2.0, overlap=1.0)
    ...
    for method in ["coh", "plv", "sxy"]:
        for mode in ["morlet", "multitaper"]:
            ...
            np.save(
                f"./mne_connectivity/tests/data/test_frite_dataset_{mode}_{method}.npy",
                frite_data,
            )
